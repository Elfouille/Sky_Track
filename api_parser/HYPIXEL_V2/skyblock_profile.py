# api_parser/HYPIXEL_V2/skyblock_profile.py
...
def main(ttl_s: int = 60):
    root = project_root_from_here(__file__)
    cache = root / "cache"
    out = cache / "HYPIXEL_V2" / "skyblock_profile.json"
    ...
    client.get_json("/skyblock/profile", out_file=out, params={"profile": profile_id}, ttl_s=ttl_s)
    print(f"[OK] {out}")
